...
static const uint8_t MATRIX[7][8] = {
    ...
    {200, 201, 202, 203, 204, BTN_TEMPO_UP, CELL_EMPTY, BTN_SEL}, // KO4 0-4, tempo+, sel (Casio KI5/KI7)
    {205, 206, 207, 208, 209, BTN_STOP, BTN_TEMPO_DN, CELL_EMPTY}, // KO5 5-9, stop, tempo-
