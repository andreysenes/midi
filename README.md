...
Peças desta montagem: Pico 2020, 2× EC11 sem clique, joystick KY-023, **CJMCU-2317** (MCP23017 I2C), OLED 0.91" SSD1306 (128×32, 4 pinos), barra **WS2812 8×1** (5050, 4–7 V).
...
| WS2812 DIN | GP16 |
| WS2812 4–7VDC | **VBUS (5 V)** — não use 3V3 |
| 3V3, GND | MCP + OLED + encoders + joystick (+ GND da barra WS2812) |
...
Barra de 8 LEDs em linha. Silk do lado de entrada: **GND · DIN · 4–7VDC · GND**. O outro extremo é só para encadear outra barra (**DOUT**) — deixe solto.

| Barra | Pico |
| --- | --- |
| GND (qualquer um dos dois) | GND |
| DIN | GP16 |
| 4–7VDC | **VBUS** (5 V no USB) |
| DOUT | nada |

DIN do WS2812 aceita 3,3 V na prática. Se as cores saírem erradas, um resistor de 330 Ω entre GP16 e DIN. Brilho no máximo puxa ~60 mA por LED — 8 brancos chegam a ~0,5 A; por isso **VBUS**, não o 3V3 do Pico.
